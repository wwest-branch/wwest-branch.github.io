(function() {// Input 0
  ...
  var banner_html = {banner:function(a, b) {
    ...
    var d = utils.mobileUserAgent(), d = '<html style="display: none"><head></head><body class="' + ("ios" === d || "ipad" === d ? "branch-banner-ios" : "android" === d ? "branch-banner-android" : "branch-banner-desktop") + '"><div id="branch-banner" class="branch-animation">' + banner_html.banner(a, b) + "</body></html>";
