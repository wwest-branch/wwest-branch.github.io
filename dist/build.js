...
journeys_utils.addIframeOuterCSS = function(a) {
  ...
  a || ("top" === journeys_utils.position ? document.body.style.transform = "translate(0, " + (+e + c).toString() + "px)" : "bottom" === journeys_utils.position && (document.body.style.marginBottom = (+e + d).toString() + "px"));
