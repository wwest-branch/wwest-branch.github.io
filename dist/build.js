...
journeys_utils.addIframeOuterCSS = function(a) {
  ...
  a || ("top" === journeys_utils.position ? (document.body.style.marginTop = (+e + c).toString() + "px", "fixed" === journeys_utils.sticky && 576 <= f && (document.body.style.overflow = "hidden")) : "bottom" === journeys_utils.position && (document.body.style.marginBottom = (+e + d).toString() + "px"));
