(function () {
  ...
  var config = {
    ...
    api_endpoint: "https://api.branch.io",
    version: "2.58.1",
  };
  // Input 3
  var safejson = {
    ...
    if (a || b) {
      for (
        var c = config.link_service_endpoint + "/a/" + a + "?",
          d =
            "tags alias channel feature stage campaign type duration sdk source data".split(
              " "
            ),
          e = 0;
        e < d.length;
  ...
  var BRANCH_STANDARD_EVENTS =
    ...
    BRANCH_STANDARD_EVENT_DATA =
      "transaction_id revenue currency shipping tax coupon affiliation search_query description".split(
        " "
      );
  ...
  journeys_utils.addDynamicCtaText = function (a, b) {
    a.contentWindow.document.getElementById("branch-mobile-action").innerHTML =
      b;
  };
  ...
  Branch.prototype.init = wrap(
    ...
    function (a, b, c) {
      utils.navigationTimingAPIEnabled &&
        (utils.instrumentation["init-began-at"] =
          utils.timeSinceNavigationStart());
      var d = this;
