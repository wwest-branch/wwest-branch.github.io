(function () {
    ...
    function (a) {
      return a
        ...
        : function (a, c) {
            ...
            void 0 === c && (c = b.length);
            for (
              var e = Math.max(0, Math.min(c | 0, b.length)), f = a.length;
              0 < f && 0 < e;
      ...
      return a
        ...
        : function (a, c) {
            ...
            for (
              var e = b.length,
                f = a.length,
                g = Math.max(0, Math.min(c | 0, b.length)),
                h = 0;
              h < f && g < e;
  ...
  goog.exportPath_ = function (a, b, c) {
    ...
    for (var d; a.length && (d = a.shift()); ) {
      !a.length && goog.isDef(b)
        ? (c[d] = b)
        : (c =
            c[d] && Object.prototype.hasOwnProperty.call(c, d)
              ? c[d]
              : (c[d] = {}));
    }
  };
  ...
  utils.userPreferences = {
    ...
    allowErrorsInCallback: !1,
    shouldBlockRequest: function (a, b) {
  ...
  utils.generateDynamicBNCLink = function (a, b) {
    if (a || b) {
      for (
        var c = config.link_service_endpoint + "/a/" + a + "?",
          d = "tags alias channel feature stage campaign type duration sdk source data".split(
            " "
          ),
          e = 0;
        e < d.length;
        ...
        if (g) {
          if ("tags" === f && Array.isArray(g)) {
            for (var h = 0; h < g.length; h++) {
              c =
                ("?" === c[c.length - 1] ? c + f : c + "&" + f) +
                "=" +
                encodeURIComponent(g[h]);
            }
          } else {
            if (
              ("string" === typeof g && 0 < g.length) ||
              "number" === typeof g
            ) {
              "data" === f &&
                "string" === typeof g &&
                (g = utils.base64encode(g)),
                (c =
                  ("?" === c[c.length - 1] ? c + f : c + "&" + f) +
                  "=" +
  ...
  utils.cleanApplicationAndSessionStorage = function (a) {
    a &&
      ((a.device_fingerprint_id = null),
      (a.sessionLink = null),
      (a.session_id = null),
      (a.identity_id = null),
      (a.identity = null),
      (a.browser_fingerprint_id = null),
      a._deepviewCta && delete a._deepviewCta,
      a._deepviewRequestForReplay && delete a._deepviewRequestForReplay,
      a._storage.remove("branch_view_enabled"),
      session.set(a._storage, {}, !0));
  };
  ...
  utils.whiteListSessionData = function (a) {
    return {
      ...
      has_app: utils.getBooleanOrNull(a.has_app),
  ...
  utils.getParameterByName = function (a) {
    ...
    return (a = new RegExp("[?&]" + a + "(=([^&#]*)|&|#|$)").exec(b)) && a[2]
  ...
  utils.cleanLinkData = function (a) {
    ...
    b.$og_description ||
      (b.$og_description = utils.getOpenGraphContent("description"));
    ...
    "string" === typeof b.$desktop_url &&
      (b.$desktop_url = b.$desktop_url
  ...
  utils.processReferringLink = function (a) {
    return a
      ? "http" !== a.substring(0, 4)
        ? config.link_service_endpoint + a
        : a
      : null;
  };
  ...
  utils.mobileUserAgent = function () {
    ...
    return a.match(/android/i)
      ? "android"
      : a.match(/ipad/i) || isSafari13OrGreateriPad(a)
      ? "ipad"
      : a.match(/i(os|p(hone|od))/i)
      ? "ios"
      : a.match(/\(BB[1-9][0-9]*\;/i)
      ? "blackberry"
      : a.match(/Windows Phone/i)
      ? "windows_phone"
      : a.match(/Kindle/i) ||
        a.match(/Silk/i) ||
        a.match(/KFTT/i) ||
  ...
  utils.encodeBFPs = function (a) {
    a &&
      a.browser_fingerprint_id &&
      !utils.isBase64Encoded(a.browser_fingerprint_id) &&
      (a.browser_fingerprint_id = btoa(a.browser_fingerprint_id));
    a &&
      a.alternative_browser_fingerprint_id &&
      !utils.isBase64Encoded(a.alternative_browser_fingerprint_id) &&
      (a.alternative_browser_fingerprint_id = btoa(
        a.alternative_browser_fingerprint_id
      ));
    return a;
  };
  utils.decodeBFPs = function (a) {
    a &&
      utils.isBase64Encoded(a.browser_fingerprint_id) &&
      (a.browser_fingerprint_id = atob(a.browser_fingerprint_id));
    a &&
      utils.isBase64Encoded(a.alternative_browser_fingerprint_id) &&
      (a.alternative_browser_fingerprint_id = atob(
        a.alternative_browser_fingerprint_id
      ));
    return a;
  };
  ...
  utils.prioritizeDeeplinkPaths = function (a, b) {
    ...
    b.hostedIOS
      ? (a.$ios_deeplink_path = b.hostedIOS)
      : b.applinksIOS
      ? (a.$ios_deeplink_path = b.applinksIOS)
      : b.twitterIOS && (a.$ios_deeplink_path = b.twitterIOS);
    b.hostedAndroid
      ? (a.$android_deeplink_path = b.hostedAndroid)
      : b.applinksAndroid
      ? (a.$android_deeplink_path = b.applinksAndroid)
      : b.twitterAndroid && (a.$android_deeplink_path = b.twitterAndroid);
    a.hasOwnProperty("$ios_deeplink_path") &&
      a.hasOwnProperty("$android_deeplink_path") &&
      a.$ios_deeplink_path === a.$android_deeplink_path &&
      (a.$deeplink_path = a.$ios_deeplink_path);
    return a;
  };
  utils.processHostedDeepLinkData = function (a) {
    ...
    for (
      ...
      if (
        (a[d].getAttribute("name") || a[d].getAttribute("property")) &&
        ...
        3 === f.length &&
          "branch" === f[0] &&
          "deeplink" === f[1] &&
          ("$ios_deeplink_path" === f[2]
            ? (c.hostedIOS = utils.extractMobileDeeplinkPath(
                a[d].getAttribute("content")
              ))
            : "$android_deeplink_path" === f[2]
            ? (c.hostedAndroid = utils.extractMobileDeeplinkPath(
                a[d].getAttribute("content")
              ))
            : (b[f[2]] = a[d].getAttribute("content")));
        "al:ios:url" === e &&
          (c.applinksIOS = utils.extractMobileDeeplinkPath(
            a[d].getAttribute("content")
          ));
        "twitter:app:url:iphone" === e &&
          (c.twitterIOS = utils.extractMobileDeeplinkPath(
            a[d].getAttribute("content")
          ));
        "al:android:url" === e &&
          (c.applinksAndroid = utils.extractMobileDeeplinkPath(
            a[d].getAttribute("content")
          ));
        "twitter:app:url:googleplay" === e &&
          (c.twitterAndroid = utils.extractMobileDeeplinkPath(
            a[d].getAttribute("content")
          ));
      }
    }
  ...
  var validCommerceEvents = ["purchase"],
    ...
    validateCommerceDataKeys = function (a) {
      var b = "sku name price quantity brand category variant".split(" "),
        c = utils.calculateDiffBetweenArrays(
      ...
      if (a.hasOwnProperty("products")) {
        ...
        a.products.forEach(function (a) {
          "object" !== typeof a &&
            (e = commerceEventMessages.invalidProductType);
  ...
  utils.validateCommerceEventParams = function (a, b) {
    if (
      !a ||
      "string" !== typeof a ||
      -1 === validCommerceEvents.indexOf(a.toLowerCase())
    ) {
  ...
  utils.openGraphDataAsObject = function () {
    ...
    return (a = utils.addPropertyIfNotNull(
      a,
      "$og_type",
  ...
  var BRANCH_STANDARD_EVENTS = "ADD_TO_CART ADD_TO_WISHLIST VIEW_CART INITIATE_PURCHASE ADD_PAYMENT_INFO PURCHASE SPEND_CREDITS SEARCH VIEW_ITEM VIEW_ITEMS RATE SHARE COMPLETE_REGISTRATION COMPLETE_TUTORIAL ACHIEVE_LEVEL UNLOCK_ACHIEVEMENT LOGIN SUBSCRIBE START_TRIAL INVITE RESERVE VIEW_AD CLICK_AD INITIATE_STREAM COMPLETE_STREAM".split(
    ...
    BRANCH_STANDARD_EVENT_DATA = "transaction_id revenue currency shipping tax coupon affiliation search_query description".split(
      " "
    );
  ...
  utils.separateEventAndCustomData = function (a) {
    ...
    for (
      var b = utils.calculateDiffBetweenArrays(
  ...
  utils.convertObjectValuesToString = function (a) {
    if (
      !utils.validateParameterType(a, "object") ||
      0 === Object.keys(a).length
    ) {
      return {};
    }
    for (var b in a) {
      a.hasOwnProperty(b) &&
        (a[b] =
          utils.validateParameterType(a[b], "object") ||
          utils.validateParameterType(a[b], "array")
            ? safejson.stringify(a[b])
            : a[b].toString());
    }
    return a;
  };
  ...
  // Input 6
  var resources = {},
    validationTypes = { OBJECT: 0, STRING: 1, NUMBER: 2, ARRAY: 3, BOOLEAN: 4 },
    _validator;
  ...
  function defaults(a) {
    var b = {
      browser_fingerprint_id: validator(!0, validationTypes.STRING),
      identity_id: validator(!0, validationTypes.STRING),
      sdk: validator(!0, validationTypes.STRING),
      session_id: validator(!0, validationTypes.STRING),
    };
  ...
  resources.open = {
    ...
    params: {
      browser_fingerprint_id: validator(!1, validationTypes.STRING),
      alternative_browser_fingerprint_id: validator(!1, validationTypes.STRING),
      identity_id: validator(!1, validationTypes.STRING),
      link_identifier: validator(!1, validationTypes.STRING),
      sdk: validator(!1, validationTypes.STRING),
      options: validator(!1, validationTypes.OBJECT),
      initial_referrer: validator(!1, validationTypes.STRING),
      tracking_disabled: validator(!1, validationTypes.BOOLEAN),
      current_url: validator(!1, validationTypes.STRING),
      screen_height: validator(!1, validationTypes.NUMBER),
      screen_width: validator(!1, validationTypes.NUMBER),
    },
  };
  resources._r = {
    ...
    params: {
      sdk: validator(!0, validationTypes.STRING),
      _t: validator(!1, validationTypes.STRING),
      branch_key: validator(!0, validationTypes.STRING),
    },
  };
  resources.linkClick = {
    destination: "",
    endpoint: "",
    method: utils.httpMethod.GET,
    queryPart: { link_url: validator(!0, validationTypes.STRING) },
    params: { click: validator(!0, validationTypes.STRING) },
  };
  resources.SMSLinkSend = {
    ...
    params: {
      sdk: validator(!1, validationTypes.STRING),
      phone: validator(!0, validationTypes.STRING),
    },
  };
  resources.getCode = {
    destination: config.api_endpoint,
    ...
    method: utils.httpMethod.POST,
    params: defaults({
      amount: validator(!0, validationTypes.NUMBER),
      bucket: validator(!1, validationTypes.STRING),
      calculation_type: validator(!0, validationTypes.NUMBER),
      creation_source: validator(!0, validationTypes.NUMBER),
      expiration: validator(!1, validationTypes.STRING),
      location: validator(!0, validationTypes.NUMBER),
      prefix: validator(!1, validationTypes.STRING),
      type: validator(!0, validationTypes.STRING),
    }),
  };
  resources.validateCode = {
    ...
    endpoint: "/v1/referralcode",
    method: utils.httpMethod.POST,
    queryPart: { code: validator(!0, validationTypes.STRING) },
    params: defaults({}),
  };
  resources.applyCode = {
    destination: config.api_endpoint,
  ...
  resources.logout = {
    ...
    endpoint: "/v1/logout",
    method: utils.httpMethod.POST,
    params: defaults({ session_id: validator(!0, validationTypes.STRING) }),
  };
  resources.profile = {
    destination: config.api_endpoint,
    endpoint: "/v1/profile",
  ...
  resources.referrals = {
    ...
    method: utils.httpMethod.GET,
    queryPart: { identity_id: validator(!0, validationTypes.STRING) },
    params: defaults({}),
  };
  resources.creditHistory = {
    ...
    method: utils.httpMethod.GET,
    params: defaults({
      begin_after_id: validator(!1, validationTypes.STRING),
      bucket: validator(!1, validationTypes.STRING),
      direction: validator(!1, validationTypes.NUMBER),
      length: validator(!1, validationTypes.NUMBER),
      link_click_id: validator(!1, validationTypes.STRING),
    }),
  };
  resources.credits = {
    destination: config.api_endpoint,
  ...
  resources.redeem = {
    ...
    params: defaults({
      amount: validator(!0, validationTypes.NUMBER),
      bucket: validator(!0, validationTypes.STRING),
      identity_id: validator(!0, validationTypes.STRING),
    }),
  };
  resources.link = {
    ...
    ref: "obj",
    params: defaults({
      alias: validator(!1, validationTypes.STRING),
      campaign: validator(!1, validationTypes.STRING),
      channel: validator(!1, validationTypes.STRING),
      data: validator(!1, validationTypes.STRING),
      feature: validator(!1, validationTypes.STRING),
      identity_id: validator(!0, validationTypes.STRING),
      stage: validator(!1, validationTypes.STRING),
      tags: validator(!1, validationTypes.ARRAY),
      type: validator(!1, validationTypes.NUMBER),
      source: validator(!1, validationTypes.STRING),
      instrumentation: validator(!1, validationTypes.STRING),
    }),
  };
  resources.qrCode = {
    destination: config.api_endpoint,
    ...
    params: defaults({
      ...
      channel: validator(!1, validationTypes.STRING),
      data: validator(!1, validationTypes.STRING),
      qr_code_settings: validator(!1, validationTypes.STRING),
      feature: validator(!1, validationTypes.STRING),
      identity_id: validator(!0, validationTypes.STRING),
      stage: validator(!1, validationTypes.STRING),
      tags: validator(!1, validationTypes.ARRAY),
  ...
  resources.deepview = {
    ...
    params: defaults({
      ...
      _t: validator(!1, validationTypes.STRING),
      channel: validator(!1, validationTypes.STRING),
      data: validator(!0, validationTypes.STRING),
      feature: validator(!1, validationTypes.STRING),
      link_click_id: validator(!1, validationTypes.STRING),
      open_app: validator(!1, validationTypes.BOOLEAN),
      append_deeplink_path: validator(!1, validationTypes.BOOLEAN),
      stage: validator(!1, validationTypes.STRING),
      tags: validator(!1, validationTypes.ARRAY),
      deepview_type: validator(!0, validationTypes.STRING),
      source: validator(!0, validationTypes.STRING),
    }),
  };
  resources.hasApp = {
    destination: config.api_endpoint,
  ...
  resources.event = {
    ...
    method: utils.httpMethod.POST,
    params: defaults({
      event: validator(!0, validationTypes.STRING),
      metadata: validator(!0, validationTypes.OBJECT),
      initial_referrer: validator(!1, validationTypes.STRING),
      tracking_disabled: validator(!1, validationTypes.BOOLEAN),
    }),
  };
  resources.commerceEvent = {
    ...
    params: defaults({
      event: validator(!0, validationTypes.STRING),
      metadata: validator(!1, validationTypes.OBJECT),
      initial_referrer: validator(!1, validationTypes.STRING),
      commerce_data: validator(!0, validationTypes.OBJECT),
    }),
  };
  resources.logStandardEvent = {
    ...
    method: utils.httpMethod.POST,
    params: {
      name: validator(!0, validationTypes.STRING),
      user_data: validator(!0, validationTypes.STRING),
      custom_data: validator(!1, validationTypes.STRING),
      event_data: validator(!1, validationTypes.STRING),
      content_items: validator(!1, validationTypes.STRING),
      customer_event_alias: validator(!1, validationTypes.STRING),
    },
  };
  ...
  resources.pageview = {
    ...
    params: defaults({
      ...
      initial_referrer: validator(!1, validationTypes.STRING),
      tracking_disabled: validator(!1, validationTypes.BOOLEAN),
      branch_view_id: validator(!1, validationTypes.STRING),
      no_journeys: validator(!1, validationTypes.BOOLEAN),
      user_language: validator(!1, validationTypes.STRING),
      open_app: validator(!1, validationTypes.BOOLEAN),
      has_app_websdk: validator(!1, validationTypes.BOOLEAN),
      source: validator(!1, validationTypes.STRING),
      feature: validator(!1, validationTypes.STRING),
      is_iframe: validator(!1, validationTypes.BOOLEAN),
      data: validator(!1, validationTypes.OBJECT),
      callback_string: validator(!1, validationTypes.STRING),
      journey_displayed: validator(!1, validationTypes.BOOLEAN),
      audience_rule_id: validator(!1, validationTypes.STRING),
      journey_dismissals: validator(!1, validationTypes.OBJECT),
      identity_id: validator(!1, validationTypes.STRING),
    }),
  };
  resources.dismiss = {
    ...
    params: defaults({
      ...
      audience_rule_id: validator(!1, validationTypes.STRING),
      journey_dismissals: validator(!1, validationTypes.OBJECT),
      dismissal_source: validator(!1, validationTypes.STRING),
    }),
  };
  resources.crossPlatformIds = {
    ...
    endpoint: "/v1/cpid",
    method: utils.httpMethod.POST,
    params: { user_data: validator(!0, validationTypes.STRING) },
  };
  ...
  // Input 7
  var COOKIE_MS = 31536e6,
    BRANCH_KEY_PREFIX = "BRANCH_WEBSDK_KEY",
    storage,
    BranchStorage = function (a) {
    ...
    prefix = function (a) {
      return "branch_session" === a || "branch_session_first" === a
        ? a
        : BRANCH_KEY_PREFIX + a;
    },
    ...
    processCookie = function (a) {
      ...
      return {
        ...
        value: retrieveValue(a.substring(b + 1, a.length)),
      };
    },
      ...
      return {
        getAll: function () {
          ...
          var a = null,
            d;
          for (d in b) {
            0 === d.indexOf(BRANCH_KEY_PREFIX) &&
              (null === a && (a = {}),
              (a[trimPrefix(d)] = retrieveValue(b.getItem(d))));
          }
          return utils.decodeBFPs(a);
        },
        get: function (a, d) {
          return "browser_fingerprint_id" === a ||
            "alternative_browser_fingerprint_id" === a
            ? d && localStorage
              ? utils.base64Decode(localStorage.getItem(prefix(a)))
              : utils.base64Decode(b.getItem(prefix(a)))
            : retrieveValue(
                d && localStorage
        ...
        set: function (a, d, e) {
          e && localStorage
            ? localStorage.setItem(prefix(a), d)
  ...
  var cookies = function () {
    ...
    return {
      getAll: function () {
        for (
          var a = {}, c = document.cookie.split(";"), d = 0;
          d < c.length;
          d++
        ) {
          ...
          e &&
            ...
            isBranchCookie(e.name) &&
            (a[trimPrefix(e.name)] = e.value);
        }
        return a;
      },
      get: function (a) {
  ...
  var session = {
    get: function (a, b) {
      try {
        var c =
          safejson.parse(
            a.get(b ? "branch_session_first" : "branch_session", b)
          ) || null;
    ...
    update: function (a, b) {
      if (b) {
        var c = session.get(a) || {},
          c = goog.json.serialize(utils.encodeBFPs(utils.merge(c, b)));
    ...
    patch: function (a, b, c, d) {
      ...
      c &&
        ((c = a.get("branch_session_first", !0) || {}),
        a.set("branch_session_first", goog.json.serialize(e(c, b)), !0));
    },
  };
  // Input 9
  var Server = function () {};
  ...
  Server.prototype.serializeObject = function (a, b) {
    ...
    for (d in a) {
      a.hasOwnProperty(d) &&
        (a[d] instanceof Array || "object" === typeof a[d]
          ? c.push(this.serializeObject(a[d], b ? b + "." + d : d))
          : c.push(
              encodeURIComponent(b ? b + "." + d : d) +
                "=" +
  ...
  Server.prototype.getUrl = function (a, b) {
    ...
    if ("undefined" !== typeof a.queryPart) {
      for (c in a.queryPart) {
        if (a.queryPart.hasOwnProperty(c)) {
          if (
            (d =
              "function" === typeof a.queryPart[c]
                ? a.queryPart[c](a.endpoint, c, b[c])
                : d)
          ) {
            return { error: d };
          }
    ...
    if (
      ...
      "/v1/pageview" !== a.endpoint &&
      "/v1/dismiss" !== a.endpoint
    ) {
      for (c in a.params) {
      ...
      ("/v1/pageview" !== a.endpoint && "/v1/dismiss" !== a.endpoint) ||
        utils.merge(k, b);
    }
    ...
    "/v1/event" === a.endpoint &&
      ((k.metadata = safejson.stringify(k.metadata || {})),
      k.hasOwnProperty("commerce_data") &&
        (k.commerce_data = safejson.stringify(k.commerce_data || {})));
    ("/v1/pageview" === a.endpoint || "/v1/dismiss" === a.endpoint) &&
      k.metadata &&
      (k.metadata = safejson.stringify(k.metadata || {}));
    "/v1/open" === a.endpoint &&
      (k.options = safejson.stringify(k.options || {}));
  ...
  Server.prototype.createScript = function (a, b, c) {
    ...
    !a || 1 > a.length
      ? "function" === typeof b && b()
      : (a[0].appendChild(d),
        "function" === typeof b && utils.addEvent(d, "error", b),
        "function" === typeof c && utils.addEvent(d, "load", c));
  };
  Server.prototype.jsonpRequest = function (a, b, c, d) {
    var e = Date.now(),
      f = utils.currentRequestBrttTag;
    0 === this._jsonp_callback_index &&
      utils.isSafari11OrGreater() &&
      this._jsonp_callback_index++;
    var g = "branch_callback__" + this._jsonp_callback_index++,
      h = 0 <= a.indexOf("branch.io") ? "&data=" : "&post_data=";
    b =
      "POST" === c
        ? encodeURIComponent(utils.base64encode(goog.json.serialize(b)))
        : "";
      ...
      if (4 === l.readyState) {
        if (
          ...
          if (402 === l.status) {
            ...
            if (
              "4" === l.status.toString().substring(0, 1) ||
              "5" === l.status.toString().substring(0, 1)
            ) {
              l.responseURL && l.responseURL.includes("v2/event")
                ? e(l.responseText, null, l.status)
                : e(Error("Error in API: " + l.status), null, l.status);
            }
          }
        }
      }
  ...
  Server.prototype.request = function (a, b, c, d) {
    var e = this;
    utils.currentRequestBrttTag =
      "/v1/pageview" === a.endpoint && b && b.journey_displayed
        ? a.endpoint + "-1-brtt"
        : a.endpoint + "-brtt";
    ("/v1/url" === a.endpoint || "/v1/has-app" === a.endpoint) &&
      1 < Object.keys(utils.instrumentation).length &&
      (delete utils.instrumentation["-brtt"],
      (b.instrumentation = safejson.stringify(
    ...
    var m = utils.retries,
      n = function (b, c, f) {
        ...
        b && 0 < m && "5" === (f || "").toString().substring(0, 1)
          ? (m--,
    ...
    if (
      ...
      utils.userPreferences.shouldBlockRequest(h, b)
    ) {
      return utils.userPreferences.allowErrorsInCallback
        ? n(Error(utils.messages.trackingDisabled), null, 300)
        : n(null, {}, 200);
    }
    var p = !1,
      q;
    ...
    var r = function () {
      c.get("use_jsonp") || a.jsonp
        ? e.jsonpRequest(h, b, a.method, n)
        : e.XHRRequest(h, k, a.method, c, n, p, q);
    };
    r();
  };
  // Input 10
  var banner_utils = {
    ...
    getBodyStyle: function (a) {
      return document.body.currentStyle
        ? document.body.currentStyle[utils.snakeToCamel(a)]
        : window.getComputedStyle(document.body).getPropertyValue(a);
    },
    addCSSLengths: function (a, b) {
      var c = function (a) {
        ...
        a = a.match(/\d+/g);
        var d = parseInt(0 < a.length ? a[0] : "0", 10),
          g = function () {
            return (
              Math.max(
    ...
    shouldAppend: function (a, b) {
      ...
      return (
        ...
        (c || d) &&
        ((b.showDesktop && !utils.mobileUserAgent()) ||
          (b.showAndroid && "android" === utils.mobileUserAgent()) ||
          (b.showiPad && "ipad" === utils.mobileUserAgent()) ||
          (b.showiOS && "ios" === utils.mobileUserAgent()) ||
          (b.showBlackberry && "blackberry" === utils.mobileUserAgent()) ||
          (b.showWindowsPhone && "windows_phone" === utils.mobileUserAgent()) ||
          (b.showKindle && "kindle" === utils.mobileUserAgent()))
      );
    },
  };
  // Input 11
  var banner_css = {
    banner: function (a) {
      return (
        ...
        (a.buttonBorderColor || ("dark" === a.theme ? "transparent" : "#ccc")) +
        "; background: " +
        (a.buttonBackgroundColor || "#fff") +
        "; color: " +
        (a.buttonFontColor || "#000") +
        ...
        (a.buttonBorderColorHover ||
          ("dark" === a.theme ? "transparent" : "#BABABA")) +
        "; background: " +
        (a.buttonBackgroundColorHover || "#E0E0E0") +
        "; color: " +
        (a.buttonFontColorHover || "#000") +
    ...
    ios: "",
    android:
      "#branch-banner #branch-banner-close,#branch-banner .theme-dark #branch-banner-close { height:17px; width: 17px; text-align: center; font-size: 15px; top: 24px;  border-radius:14px; border:0; line-height:14px; color:#b1b1b3; background:#efefef; padding: 0; opacity: 0; }\n#branch-banner .button { top: 0; text-decoration:none; border-bottom: 3px solid #A4C639; padding: 0 10px; height: 24px; line-height: 24px; text-align: center; color: #fff; margin-top: 2px;  font-weight: bold; background-color: #A4C639; border-radius: 5px; }\n#branch-banner .button:hover { border-bottom:3px solid #8c9c29; background-color: #c1d739; }\n",
    blackberry: "",
    windows_phone: "",
    kindle: "",
  };
  ...
  banner_css.css = function (a, b) {
    var c = banner_css.banner(a),
      d = utils.mobileUserAgent();
    ("ios" !== d && "ipad" !== d) || !a.showiOS
      ? "android" === d && a.showAndroid
        ? (c += banner_css.mobile + banner_css.android)
        : "blackberry" === d && a.showBlackberry
        ? (c += banner_css.mobile + banner_css.blackberry)
        : "windows_phone" === d && a.showWindowsPhone
        ? (c += banner_css.mobile + banner_css.windows_phone)
        : "kindle" === d && a.showKindle
        ? (c += banner_css.mobile + banner_css.kindle)
        : ((c += banner_css.desktop),
          (c = window.ActiveXObject ? c + banner_css.ie : c + banner_css.nonie))
      : (c += banner_css.mobile + banner_css.ios);
    c += a.customCSS;
    a.iframe &&
      ((c += banner_css.inneriframe),
      ...
      (d.innerHTML =
        ...
        (utils.mobileUserAgent()
          ? banner_css.iframe_position(a.mobileSticky, a.position)
          : banner_css.iframe_position(a.desktopSticky, a.position))),
    ...
    (c = c.head || c.getElementsByTagName("head")[0]) &&
      "function" === typeof c.appendChild &&
      c.appendChild(d);
    "top" === a.position
      ? (b.style.top = "-" + banner_utils.bannerHeight)
      : "bottom" === a.position &&
        (b.style.bottom = "-" + banner_utils.bannerHeight);
  };
  // Input 12
  var banner_html = {
    banner: function (a, b) {
      ...
      if (a.rating || a.reviewCount) {
        ...
        d =
          ...
          d +
          (a.reviewCount
            ? '<span class="review-count">' + a.reviewCount + "</span>"
            : "") +
          "</div>";
      } else {
        d = "";
    ...
    markup: function (a, b) {
      var c =
        ...
        (utils.mobileUserAgent()
          ? banner_html.mobileAction(a, b)
          : banner_html.desktopAction(a)) +
        "</div>";
  ...
  var sendSMS = function (a, b, c, d) {
      var e = a.getElementById("branch-sms-phone"),
        f = a.getElementById("branch-sms-send"),
        g = a.getElementById("branch-loader-wrapper"),
        h = a.getElementById("branch-sms-form-container"),
        k,
        l = function () {
      ...
      if (e) {
        ...
        /^\d{7,}$/.test(p.replace(/[\s()+\-\.]|ext/gi, ""))
          ? (b._publishEvent("willSendBannerSMS"),
            ...
            (g.style.opacity = "1"),
            (e.className = ""),
            b.sendSMS(p, d, c, function (a) {
              a
                ? (b._publishEvent("sendBannerSMSError"), n())
                : (b._publishEvent("didSendBannerSMS"),
                  m(),
                  setTimeout(function () {
                    h.removeChild(k);
                    l();
    ...
    banner = function (a, b, c, d) {
      function e() {
        "top" === b.position
          ? (f.style.top = "0")
          : "bottom" === b.position && (f.style.bottom = "0");
      ...
      if (utils.mobileUserAgent()) {
        ...
        g.getElementById("sms-form")
          ? g
              .getElementById("sms-form")
              .addEventListener("submit", function (d) {
                d.preventDefault();
                sendSMS(g, a, b, c);
              })
          : (f.onload = function () {
      ...
      var h = banner_utils.getBodyStyle("margin-top"),
        k = document.body.style.marginTop,
        l = banner_utils.getBodyStyle("margin-bottom"),
        m = document.body.style.marginBottom,
        n = g.getElementById("branch-banner-close"),
        p = function (a, c) {
          "function" === typeof a && ((c = a), (a = {}));
          a = a || {};
          "top" === b.position
            ? (f.style.top = "-" + banner_utils.bannerHeight)
            : "bottom" === b.position &&
              (f.style.bottom = "-" + banner_utils.bannerHeight);
          "number" === typeof b.forgetHide
            ? d.set("hideBanner", banner_utils.getDate(b.forgetHide), !0)
            : d.set("hideBanner", !0, !0);
          a.immediate
            ? ("top" === b.position
                ? (document.body.style.marginTop = k)
                : "bottom" === b.position &&
                  (document.body.style.marginBottom = m),
              banner_utils.removeClass(
                document.body,
            ...
            : (setTimeout(function () {
                ...
                banner_utils.removeElement(
                  document.getElementById("branch-css")
                );
                c();
  ...
  journeys_utils.setPositionAndHeight = function (a) {
    ...
    if (b && b.bannerHeight && b.position && b.sticky) {
      (journeys_utils.bannerHeight = b.bannerHeight),
        (journeys_utils.position = b.position),
        (journeys_utils.sticky = b.sticky);
    } else {
    ...
    if (
      -1 !== journeys_utils.bannerHeight.indexOf("vh") ||
      -1 !== journeys_utils.bannerHeight.indexOf("%")
    ) {
      (a = journeys_utils.bannerHeight.indexOf("vh")
        ? journeys_utils.bannerHeight.slice(0, -2)
        : journeys_utils.bannerHeight.slice(0, -1)),
        (journeys_utils.bannerHeight =
          (a / 100) * journeys_utils.windowHeight + "px"),
        100 > a
          ? (journeys_utils.isHalfPage = !0)
          : (journeys_utils.isFullPage = !0);
    }
  };
  ...
  journeys_utils.getCtaText = function (a, b) {
    var c;
    b && a && a.ctaText && a.ctaText.has_app
      ? (c = a.ctaText.has_app)
      : a && a.ctaText && a.ctaText.no_app && (c = a.ctaText.no_app);
    return c;
  };
  ...
  journeys_utils.removeScriptAndCss = function (a) {
    var b = a.match(journeys_utils.jsonRe),
      c = a.match(journeys_utils.jsRe),
      d = a.match(journeys_utils.cssRe),
      e = a.match(journeys_utils.iframeCssRe);
      ...
      journeys_utils.divToInjectParents.forEach(function (a) {
        ...
        c &&
          (b =
            ...
            "fixed" === c.getPropertyValue("position"));
        b || (a.style.marginTop = journeys_utils.bannerHeight);
      });
    "top" === journeys_utils.previousPosition &&
      journeys_utils.previousPosition !== journeys_utils.position &&
      journeys_utils.exitAnimationDisabledPreviously &&
      journeys_utils.previousDivToInjectParents &&
      0 < journeys_utils.previousDivToInjectParents.length &&
      journeys_utils.previousDivToInjectParents.forEach(function (a) {
        a.style.marginTop = 0;
      });
    journeys_utils.exitAnimationDisabledPreviously = !1;
    journeys_utils.previousPosition = "";
  ...
  journeys_utils.addIframeInnerCSS = function (a, b) {
    ...
    "top" === journeys_utils.position
      ...
      : "bottom" === journeys_utils.position &&
        (a.style.bottom = "-" + journeys_utils.bannerHeight);
    try {
      var e = d.getElementsByClassName("branch-banner-content")[0],
        f = window
          .getComputedStyle(e)
  ...
  journeys_utils.addDynamicCtaText = function (a, b) {
    a.contentWindow.document.getElementById(
  ...
  journeys_utils._resizeListener = function () {
    journeys_utils.isSafeAreaEnabled &&
      journeys_utils._resetJourneysBannerPosition(!1, !1);
  };
  journeys_utils._scrollListener = function () {
    journeys_utils.isSafeAreaEnabled &&
      (window.pageYOffset > window.innerHeight
        ? journeys_utils._resetJourneysBannerPosition(!0, !1)
        : journeys_utils._resetJourneysBannerPosition(!1, !1));
  };
  ...
  journeys_utils._resetJourneysBannerPosition = function (a, b) {
    ...
    a
      ? (c.style.top = f - d + d / 2 + "px")
      : f - e != d && (c.style.top = "" + (f - d) + "px");
  };
  ...
  journeys_utils.finalHookups = function (a, b, c, d, e, f, g, h) {
    if (d && e) {
      var k = e.contentWindow.document.querySelectorAll(
        "#branch-mobile-action"
      );
  ...
  journeys_utils._getDismissRequestData = function (a, b) {
    var c = {},
      d = utils.getHostedDeepLinkData();
    d && 0 < Object.keys(d).length && (c.hosted_deeplink_data = d);
    c = a._getPageviewRequestData(
      journeys_utils._getPageviewMetadata(null, c),
      null,
    ...
    if (!g) {
      if (
        ...
        var l = function () {
          ...
          var b = journeys_utils._getDismissRequestData(
            h,
            utils.dismissEventToSourceMapping[a]
          );
          journeys_utils.branch._api(resources.dismiss, b, function (a, c) {
            !a &&
              "object" === typeof c &&
              c.template &&
              h.shouldDisplayJourney(c, null, !1) &&
              h.displayJourney(
                c.template,
                b,
                b.branch_view_id || c.event_data.branch_view_data.id,
                c.event_data.branch_view_data,
                !1,
                c.journey_link_data
              );
          });
  ...
  journeys_utils._getPageviewMetadata = function (a, b) {
    return utils.merge(
      {
        url: (a && a.url) || utils.getWindowLocation(),
  ...
  journeys_utils.animateBannerExit = function (a, b) {
    ...
    setTimeout(
      function () {
        ...
        banner_utils.removeElement(document.getElementById("branch-css"));
        banner_utils.removeElement(
          document.getElementById("branch-iframe-css")
        );
        banner_utils.removeElement(
          document.getElementById("branch-journey-cta")
        );
        (!journeys_utils.exitAnimationDisabled ||
  ...
  journeys_utils.setJourneyLinkData = function (a) {
    ...
    a &&
      "object" === typeof a &&
      0 < Object.keys(a).length &&
      (utils.removePropertiesFromObject(a, [
        "browser_fingerprint_id",
        "app_id",
        "source",
        "open_app",
      ...
      (b.journey_link_data = {}),
      utils.merge(b.journey_link_data, a));
    journeys_utils.journeyLinkData = b;
  };
  journeys_utils.getValueForKeyInBranchViewData = function (a) {
    return journeys_utils &&
      journeys_utils.branch &&
      journeys_utils.branch._branchViewData &&
      journeys_utils.branch._branchViewData.data
      ? journeys_utils.branch._branchViewData.data[a]
      : !1;
  };
  journeys_utils.hasJourneyCtaLink = function () {
    return journeys_utils.getValueForKeyInBranchViewData("$journeys_cta")
      ? 0 <
          journeys_utils.getBranchViewDataItemOrUndefined("$journeys_cta")
            .length
      : !1;
  };
  ...
  journeys_utils.trySetJourneyUrls = function (a, b) {
    b =
      void 0 === b
        ? ["$android_url", "$ios_url", "$fallback_url", "$desktop_url"]
        : b;
    if (!a) {
      return a;
    }
  ...
  function renderHtmlBlob(a, b, c) {
    ...
    e &&
      ((d = journeys_utils.getCtaText(e, c)),
      journeys_utils.findInsertionDiv(a, e));
  ...
  branch_view.shouldDisplayJourney = function (a, b, c) {
    return !checkPreviousBanner() &&
      utils.mobileUserAgent() &&
      a.event_data &&
      a.template
      ? c
        ? !0
        : !a.event_data.branch_view_data.id ||
          (b && b.no_journeys) ||
          _areJourneysDismissedGlobally(journeys_utils.branch)
        ? ((branch_view.callback_index = 1), !1)
        : !0
      : !1;
  };
  ...
  branch_view.displayJourney = function (a, b, c, d, e, f) {
    if (!journeys_utils.exitAnimationIsRunning) {
      ...
      var h = !1,
        ...
        l = null,
        m = null,
        n = journeys_utils.branch._storage;
      if (a) {
      ...
      utils.userPreferences.trackingDisabled ||
        e ||
        branch_view.incrementPageviewAnalytics(d);
    }
  };
  branch_view._getPageviewRequestData = function (a, b, c, d) {
    ...
    var e = utils.merge({}, c._branchViewData),
      f = session.get(c._storage) || {},
      g = f.hasOwnProperty("has_app") ? f.has_app : !1,
      h = c._storage.get("journeyDismissals", !0),
      k =
        (
          b.user_language ||
          utils.getBrowserLanguageCode() ||
      ...
      l = utils.getInitialReferrer(c._referringLink()),
      m =
        b.branch_view_id || utils.getParameterByName("_branch_view_id") || null;
    c = b.make_new_link
      ? null
      : utils.getClickIdAndSearchStringFromLink(c._referringLink());
    ...
    (a = f.data ? safejson.parse(f.data) : null) &&
      a["+referrer"] &&
      (e.data["+referrer"] = a["+referrer"]);
  ...
  function addAppIndexingTag(a) {
    ...
    "android" === a &&
      ...
      ((b =
        "android-app://" +
        appindexing.options.androidPackageName +
        "/" +
        appindexing.options.androidURL),
    ...
    "ios" === a &&
      ...
      ((b =
        "ios-app://" +
        appindexing.options.iosAppId +
        "/" +
        appindexing.options.iosURL),
      (b = addBranchTrackingParams(b)),
      writeToDOM(b));
  }
  function addBranchTrackingParams(a) {
    var b = {
      ...
      $canonical_url: utils.getWindowLocation(),
    };
    if ("object" === typeof appindexing.options.data) {
      for (var c in appindexing.options.data) {
        appindexing.options.data.hasOwnProperty(c) &&
          !b.hasOwnProperty(c) &&
          (b[c] = appindexing.options.data[c]);
      }
    }
    c = -1 < a.indexOf("?") ? "&" : "?";
  ...
  appindexing.updateAppIndexingTagsIfPresent = function () {
    ...
    if (b) {
      for (var c = 0; c < b; c++) {
        ...
        e &&
          (e.includes("ios-app") &&
            ((appindexing.state.iosAppIndexingTagsPresent = !0),
            d.setAttribute("href", addBranchTrackingParams(e))),
          e.includes("android-app") &&
            ((appindexing.state.androidAppIndexingTagsPresent = !0),
            d.setAttribute("href", addBranchTrackingParams(e))));
      }
    }
  };
  appindexing.insertAppIndexingTagsFromConfig = function (a) {
    "android" === a &&
      "string" === typeof appindexing.options.androidPackageName &&
      "string" === typeof appindexing.options.androidURL &&
      ((appindexing.state.androidDetailsComplete = !0),
      addAppIndexingTag("android"));
    "ios" === a &&
      "string" === typeof appindexing.options.iosAppId &&
      "string" === typeof appindexing.options.iosURL &&
      ((appindexing.state.iosDetailsComplete = !0), addAppIndexingTag("ios"));
  };
  appindexing.populateConfigFromAppLinksTags = function (a) {
    for (
      ...
      var d = b[c];
      "ios" === a &&
        "al:ios:app_store_id" === d.getAttribute("property") &&
        (appindexing.options.iosAppId = d.getAttribute("content"));
      "ios" === a &&
        "al:ios:url" === d.getAttribute("property") &&
        (appindexing.options.iosURL = d
          .getAttribute("content")
          .replace("://", "/"));
      "android" === a &&
        "al:android:package" === d.getAttribute("property") &&
        (appindexing.options.androidPackageName = d.getAttribute("content"));
      "android" === a &&
        "al:android:url" === d.getAttribute("property") &&
        (appindexing.options.androidURL = d
          .getAttribute("content")
          .replace("://", "/"));
    }
  ...
  // Input 17
  var default_branch,
    callback_params = { NO_CALLBACK: 0, CALLBACK_ERR: 1, CALLBACK_ERR_DATA: 2 },
    init_states = {
      NO_INIT: 0,
      INIT_PENDING: 1,
      INIT_FAILED: 2,
    ...
    wrap = function (a, b, c) {
      return function () {
        ...
        a === callback_params.NO_CALLBACK || "function" !== typeof g
          ? ((f = function (a) {}), (e = Array.prototype.slice.call(arguments)))
          : ((e =
        ...
        d._queue(function (g) {
          var h = function (b, c) {
            try {
              ...
              a === callback_params.CALLBACK_ERR
                ? f(b)
                : a === callback_params.CALLBACK_ERR_DATA && f(b, c);
            } finally {
              g();
            }
          };
              ...
              return h(
                Error(
                  utils.message(
                    ...
                    d.init_state_fail_code,
                    d.init_state_fail_details
                  )
                ),
                null
              );
    ...
    Branch = function () {
      if (!(this instanceof Branch)) {
        return (
          default_branch || (default_branch = new Branch()), default_branch
        );
      }
  ...
  Branch.prototype._api = function (a, b, c) {
    ...
    ((a.params && a.params.session_id) ||
      (a.queryPart && a.queryPart.session_id)) &&
      this.session_id &&
      (b.session_id = this.session_id);
    ((a.params && a.params.identity_id) ||
      (a.queryPart && a.queryPart.identity_id)) &&
      this.identity_id &&
      (b.identity_id = this.identity_id);
    0 > a.endpoint.indexOf("/v1/")
      ? ((a.params && a.params.developer_identity) ||
          (a.queryPart && a.queryPart.developer_identity)) &&
        this.identity &&
        (b.developer_identity = this.identity)
      : ((a.params && a.params.identity) ||
          (a.queryPart && a.queryPart.identity)) &&
        this.identity &&
        (b.identity = this.identity);
    ((a.params && a.params.link_click_id) ||
      (a.queryPart && a.queryPart.link_click_id)) &&
      this.link_click_id &&
      (b.link_click_id = this.link_click_id);
    ((a.params && a.params.sdk) || (a.queryPart && a.queryPart.sdk)) &&
      this.sdk &&
      (b.sdk = this.sdk);
    ((a.params && a.params.browser_fingerprint_id) ||
      (a.queryPart && a.queryPart.browser_fingerprint_id)) &&
      this.browser_fingerprint_id &&
      (b.browser_fingerprint_id = this.browser_fingerprint_id);
    utils.userPreferences.trackingDisabled &&
      (b.tracking_disabled = utils.userPreferences.trackingDisabled);
  ...
  Branch.prototype._referringLink = function () {
    ...
    return (a = a && a.referring_link)
      ? a
      : (a = this._storage.get("click_id"))
      ? config.link_service_endpoint + "/c/" + a
      : null;
  };
  Branch.prototype._publishEvent = function (a, b) {
    for (var c = 0; c < this._listeners.length; c++) {
      (this._listeners[c].event && this._listeners[c].event !== a) ||
        this._listeners[c].listener(a, b);
    }
  };
  Branch.prototype.init = wrap(
    ...
    function (a, b, c) {
      ...
      d.init_options = c;
      utils.retries =
        c && c.retries && Number.isInteger(c.retries)
          ? c.retries
          : utils.retries;
      utils.retry_delay =
        c && c.retry_delay && Number.isInteger(c.retry_delay)
          ? c.retry_delay
          : utils.retry_delay;
      utils.timeout =
        c && c.timeout && Number.isInteger(c.timeout)
          ? c.timeout
          : utils.timeout;
      utils.nonce = c && c.nonce ? c.nonce : utils.nonce;
      utils.userPreferences.trackingDisabled =
        c && c.tracking_disabled && !0 === c.tracking_disabled ? !0 : !1;
      utils.userPreferences.allowErrorsInCallback = !1;
      utils.userPreferences.trackingDisabled &&
        utils.cleanApplicationAndSessionStorage(d);
      ...
      var e = function (a) {
        ...
        a.referring_link &&
          (a.referring_link = utils.processReferringLink(a.referring_link));
        !a.click_id &&
          a.referring_link &&
          (a.click_id = utils.getClickIdAndSearchStringFromLink(
            a.referring_link
          ));
      ...
      var f =
          c &&
          "undefined" !== typeof c.branch_match_id &&
          null !== c.branch_match_id
            ? c.branch_match_id
            : null,
        g =
          f || utils.getParamValue("_branch_match_id") || utils.hashValue("r"),
        h = !d.identity_id;
      d._branchViewEnabled = !!d._storage.get("branch_view_enabled");
      var k = function (a) {
          var b = { sdk: config.version, branch_key: d.branch_key },
            c = session.get(d._storage) || {},
            e = session.get(d._storage, !0) || {};
          e.browser_fingerprint_id && (b._t = e.browser_fingerprint_id);
          utils.isSafari11OrGreater() ||
            utils.isIOSWKWebView() ||
            d._api(resources._r, b, function (a, b) {
              a &&
                ((d.init_state_fail_code = init_state_fail_codes.BFP_NOT_FOUND),
                (d.init_state_fail_details = a.message));
          ...
          d._api(
            ...
            function (b, e) {
              b &&
                ((d.init_state_fail_code =
                  init_state_fail_codes.HAS_APP_FAILED),
                (d.init_state_fail_details = b.message));
              b ||
                !e ||
                c.has_app ||
                ((c.has_app = !0),
                session.update(d._storage, c),
                d._publishEvent("didDownloadApp"));
              a && a(null, c);
            }
          );
        },
        ...
        m = function (b, g) {
          g &&
            ((g = e(g)),
            utils.userPreferences.trackingDisabled ||
              ((g = l(g)), session.set(d._storage, g, h)),
            (d.init_state = init_states.INIT_SUCCEEDED),
            (g.data_parsed =
              g.data && 0 !== g.data.length ? safejson.parse(g.data) : {}));
          if (b) {
            return (
              (d.init_state = init_states.INIT_FAILED),
              d.init_state_fail_code ||
                ((d.init_state_fail_code = init_state_fail_codes.UNKNOWN_CAUSE),
                (d.init_state_fail_details = b.message)),
          ...
          var k = utils.getAdditionalMetadata(),
            m = utils.validateParameterType(c.metadata, "object")
              ? c.metadata
              : null;
          m &&
            (m = utils.mergeHostedDeeplinkData(k.hosted_deeplink_data, m)) &&
            0 < Object.keys(m).length &&
            (k.hosted_deeplink_data = m);
          var n = branch_view._getPageviewRequestData(
            journeys_utils._getPageviewMetadata(c, k),
            c,
            d,
            !1
          );
          d.renderQueue(function () {
            d._api(resources.pageview, n, function (a, b) {
              if (!a && "object" === typeof b) {
                ...
                branch_view.shouldDisplayJourney(b, c, e)
                  ? branch_view.displayJourney(
                      b.template,
                      n,
                      n.branch_view_id || b.event_data.branch_view_data.id,
                      b.event_data.branch_view_data,
                      e,
                      b.journey_link_data
                    )
                  : ((b.auto_branchify ||
                      ...
                      this.branch.deepview(
                        {},
                        { make_new_link: !1, open_app: !0, auto_branchify: !0 }
                      ),
                    journeys_utils.branch._publishEvent("willNotShowJourney"));
              }
              utils.userPreferences.trackingDisabled &&
                (utils.userPreferences.allowErrorsInCallback = !0);
            });
          });
        },
        n = function () {
          ...
          b &&
            !d.changeEventListenerAdded &&
            ((d.changeEventListenerAdded = !0),
            document.addEventListener(
              b,
              function () {
                document[a] ||
                  (k(null),
                  "function" === typeof d._deepviewRequestForReplay &&
      ...
      if (b && b.session_id && !g && !utils.getParamValue("branchify_url")) {
        session.update(d._storage, { data: "" }),
          session.update(d._storage, { referring_link: "" }),
          n(),
          k(m);
      } else {
        ...
        utils.isSafari11OrGreater() || utils.isIOSWKWebView()
          ? utils.delay(function () {
              d._api(
                resources.open,
                {
                  link_identifier: g,
                  browser_fingerprint_id: g || p.browser_fingerprint_id,
                  alternative_browser_fingerprint_id: p.browser_fingerprint_id,
                  options: c,
                ...
                function (a, b) {
                  a &&
                    ((d.init_state_fail_code =
                      init_state_fail_codes.OPEN_FAILED),
                    (d.init_state_fail_details = a.message));
                  a ||
                    "object" !== typeof b ||
                    (b.branch_view_enabled &&
                      ((d._branchViewEnabled = !!b.branch_view_enabled),
                      d._storage.set(
                        "branch_view_enabled",
          ...
          : d._api(resources._r, b, function (a, b) {
              if (a) {
                return (
                  (d.init_state_fail_code =
                    init_state_fail_codes.BFP_NOT_FOUND),
                  (d.init_state_fail_details = a.message),
                  m(a, null)
                );
              }
              utils.delay(function () {
                d._api(
                  ...
                  {
                    link_identifier: g,
                    browser_fingerprint_id: g || b,
                    alternative_browser_fingerprint_id:
                      p.browser_fingerprint_id,
                    options: c,
                    initial_referrer: utils.getInitialReferrer(
                      d._referringLink()
                    ),
  ...
  Branch.prototype.renderFinalize = wrap(
    ...
    function (a) {
      this._renderQueue &&
        0 < this._renderQueue.length &&
        (this._renderQueue.forEach(function (a) {
          a.call(this);
        }),
  ...
  Branch.prototype.setIdentity = wrap(
    ...
    function (a, b) {
      ...
      this._api(resources.profile, { identity: b }, function (d, e) {
        ...
        e.referring_data_parsed = e.referring_data
          ? safejson.parse(e.referring_data)
          : null;
        session.patch(
          c._storage,
          { identity: b, identity_id: c.identity_id },
          !0
        );
        a(null, e);
      });
  ...
  Branch.prototype.logout = wrap(callback_params.CALLBACK_ERR, function (a) {
    ...
    this._api(resources.logout, {}, function (c, d) {
      ...
      d = {
        ...
        link: d.link,
        device_fingerprint_id: b.device_fingerprint_id || null,
      };
  ...
  Branch.prototype.lastAttributedTouchData = wrap(
    ...
    function (a, b) {
      ...
      this._api(
        resources.lastAttributedTouchData,
        { user_data: safejson.stringify(c) },
        function (b, c) {
  ...
  Branch.prototype.track = wrap(
    ...
    function (a, b, c, d) {
      ...
      if ("pageview" === b) {
        (b = utils.mergeHostedDeeplinkData(utils.getHostedDeepLinkData(), c)) &&
          0 < Object.keys(b).length &&
          (c.hosted_deeplink_data = b);
        var e = branch_view._getPageviewRequestData(
          journeys_utils._getPageviewMetadata(d, c),
          d,
          this,
          !1
        );
        this._api(resources.pageview, e, function (b, c) {
          if (!b && "object" === typeof c) {
            ...
            branch_view.shouldDisplayJourney(c, d, f)
              ? branch_view.displayJourney(
                  c.template,
                  e,
                  e.branch_view_id || c.event_data.branch_view_data.id,
                  c.event_data.branch_view_data,
                  f,
                  c.journey_link_data
                )
        ...
        this._api(
          resources.event,
          {
            ...
            initial_referrer: utils.getInitialReferrer(this._referringLink()),
          },
          function (b, c) {
            "function" === typeof a && a.apply(this, arguments);
          }
  ...
  Branch.prototype.logEvent = wrap(
    ...
    function (a, b, c, d, e) {
      ...
      utils.isStandardEvent(b)
        ? ((d = utils.validateParameterType(d, "array") ? d : null),
          ...
          this._api(
            resources.logStandardEvent,
            {
              name: b,
              user_data: safejson.stringify(utils.getUserData(this)),
              custom_data: safejson.stringify((c && c.custom_data) || {}),
              event_data: safejson.stringify((c && c.event_data) || {}),
              content_items: safejson.stringify(d || []),
        ...
        : this._api(
            resources.logCustomEvent,
            {
              ...
              custom_data: safejson.stringify(
                utils.convertObjectValuesToString(c || {})
              ),
              content_items: safejson.stringify(d || []),
              customer_event_alias: e,
            },
  ...
  Branch.prototype.sendSMS = wrap(
    ...
    function (a, b, c, d) {
      ...
      g && !d.make_new_link
        ? e(utils.getClickIdAndSearchStringFromLink(g))
        : f._api(resources.link, utils.cleanLinkData(c), function (b, c) {
            if (b) {
              return a(b);
            }
            var d = c.url;
            /(bnc.lt\/|app\.link\/)/.test(d) ||
              (d =
                config.link_service_endpoint +
                "/" +
                utils.extractDeeplinkPath(d));
            f._api(
              resources.linkClick,
              { link_url: d, click: "click" },
              function (b, c) {
                if (b) {
                  return a(b);
                }
  ...
  Branch.prototype.qrCode = wrap(
    callback_params.CALLBACK_ERR_DATA,
    function (a, b, c, d) {
      utils.cleanLinkData(b).qr_code_settings = safejson.stringify(
        utils.convertObjectValuesToString(c || {})
      );
      this._api(resources.qrCode, utils.cleanLinkData(b), function (b, c) {
        ...
        b ||
          ...
          (d.base64 = function () {
            if (this.rawBuffer) {
              return btoa(
                String.fromCharCode.apply(null, new Uint8Array(this.rawBuffer))
              );
            }
  ...
  Branch.prototype.deepview = wrap(
    ...
    function (a, b, c) {
      ...
      c || (c = {});
      c.deepview_type =
        "undefined" === typeof c.deepview_type ? "deepview" : "banner";
      ...
      f &&
        !c.make_new_link &&
        (b.link_click_id = utils.getClickIdAndSearchStringFromLink(f));
      b.banner_options = c;
      c.auto_branchify && (b.auto_branchify = !0);
      d._deepviewRequestForReplay = goog.bind(
        this._api,
        d,
        resources.deepview,
        b,
    ...
    function (a) {
      if ("undefined" === typeof this._deepviewCta) {
        return utils.userPreferences.trackingDisabled
          ? a(Error(utils.messages.trackingDisabled), null)
          : a(Error(utils.messages.deepviewNotCalled), null);
      }
      window.event &&
  ...
  Branch.prototype.referrals = wrap(
    callback_params.CALLBACK_ERR_DATA,
    function (a) {
      this._api(resources.referrals, {}, a);
    }
  );
  Branch.prototype.getCode = wrap(
    callback_params.CALLBACK_ERR_DATA,
    function (a, b) {
      b.type = "credit";
  ...
  Branch.prototype.validateCode = wrap(
    callback_params.CALLBACK_ERR,
    function (a, b) {
      this._api(resources.validateCode, { code: b }, a);
    }
  );
  Branch.prototype.applyCode = wrap(
    callback_params.CALLBACK_ERR,
    function (a, b) {
      this._api(resources.applyCode, { code: b }, a);
    }
  );
  Branch.prototype.credits = wrap(
    callback_params.CALLBACK_ERR_DATA,
    function (a) {
      this._api(
        resources.credits,
        { branch_key: this.branch_key, identity: this.identity },
        a
      );
    }
  );
      ...
      b.renderQueue(function () {
        if (journeys_utils.banner && journeys_utils.isJourneyDisplayed) {
          b._publishEvent(
            ...
            journeys_utils.animateBannerExit(journeys_utils.banner, !0);
        } else {
  ...
  Branch.prototype.banner = wrap(
    ...
    function (a, b, c) {
      c = c || {};
      _setBranchViewData.call(null, this, function () {}, c);
      "undefined" === typeof b.showAgain &&
        "undefined" !== typeof b.forgetHide &&
        (b.showAgain = b.forgetHide);
      var d = {
        icon: utils.cleanBannerText(b.icon) || "",
        title: utils.cleanBannerText(b.title) || "",
        description: utils.cleanBannerText(b.description) || "",
        reviewCount:
          "number" === typeof b.reviewCount && 0 < b.reviewCount
            ? Math.floor(b.reviewCount)
            : null,
        rating:
          "number" === typeof b.rating && 5 >= b.rating && 0 < b.rating
            ? Math.round(2 * b.rating) / 2
            : null,
        openAppButtonText:
          utils.cleanBannerText(b.openAppButtonText) || "View in app",
        downloadAppButtonText:
          utils.cleanBannerText(b.downloadAppButtonText) || "Download App",
        sendLinkText: utils.cleanBannerText(b.sendLinkText) || "Send Link",
        phonePreviewText:
          utils.cleanBannerText(b.phonePreviewText) || "(999) 999-9999",
        iframe: "undefined" === typeof b.iframe ? !0 : b.iframe,
        showiOS: "undefined" === typeof b.showiOS ? !0 : b.showiOS,
        showiPad: "undefined" === typeof b.showiPad ? !0 : b.showiPad,
        showAndroid: "undefined" === typeof b.showAndroid ? !0 : b.showAndroid,
        showBlackberry:
          "undefined" === typeof b.showBlackberry ? !0 : b.showBlackberry,
        showWindowsPhone:
          "undefined" === typeof b.showWindowsPhone ? !0 : b.showWindowsPhone,
        showKindle: "undefined" === typeof b.showKindle ? !0 : b.showKindle,
        showDesktop: "undefined" === typeof b.showDesktop ? !0 : b.showDesktop,
        disableHide: !!b.disableHide,
        forgetHide:
          "number" === typeof b.forgetHide ? b.forgetHide : !!b.forgetHide,
        respectDNT: "undefined" === typeof b.respectDNT ? !1 : b.respectDNT,
        position: b.position || "top",
        customCSS: b.customCSS || "",
        mobileSticky:
          "undefined" === typeof b.mobileSticky ? !1 : b.mobileSticky,
        desktopSticky:
          "undefined" === typeof b.desktopSticky ? !0 : b.desktopSticky,
        buttonBorderColor: b.buttonBorderColor || "",
        buttonBackgroundColor: b.buttonBackgroundColor || "",
        buttonFontColor: b.buttonFontColor || "",
        buttonBorderColorHover: b.buttonBorderColorHover || "",
        buttonBackgroundColorHover: b.buttonBackgroundColorHover || "",
        buttonFontColorHover: b.buttonFontColorHover || "",
        make_new_link: !!b.make_new_link,
        open_app: !!b.open_app,
        immediate: !!b.immediate,
        append_deeplink_path: !!b.append_deeplink_path,
      };
      "undefined" !== typeof b.showMobile &&
        ((d.showiOS = b.showMobile),
        (d.showAndroid = b.showMobile),
        (d.showBlackberry = b.showMobile),
        (d.showWindowsPhone = b.showMobile),
        (d.showKindle = b.showMobile));
  ...
  Branch.prototype.closeBanner = wrap(0, function (a) {
    var b = this;
    b.renderQueue(function () {
      b.closeBannerPointer &&
        (b._publishEvent("willCloseBanner"),
        b.closeBannerPointer(function () {
          b._publishEvent("didCloseBanner");
        }));
    });
    a();
  });
  Branch.prototype.autoAppIndex = wrap(
    callback_params.CALLBACK_ERR,
    function (a, b) {
      b = b || {};
      ...
      appindexing.state.iosAppIndexingTagsPresent ||
      ...
      appindexing.state.androidDetailsComplete
        ? a(null)
        : a(
            "Firebase App Indexing tags were not added to your webpage. Please check your configuration."
          );
    }
  );
      ...
      e.renderQueue(function () {
        ...
        e._api(
          resources.commerceEvent,
          {
            ...
            initial_referrer: utils.getInitialReferrer(e._referringLink()),
            commerce_data: c,
          },
          function (b, c) {
            a(b || null);
  ...
  Branch.prototype.disableTracking = wrap(
    ...
    function (a, b) {
      if (!1 === b || "false" === b) {
        (utils.userPreferences.trackingDisabled = !1),
          (utils.userPreferences.allowErrorsInCallback = !1),
          this.branch_key &&
            this.init_options &&
            (!0 === this.init_options.tracking_disabled &&
        ...
        if (void 0 === b || !0 === b || "true" === b) {
          utils.cleanApplicationAndSessionStorage(this),
            (utils.userPreferences.trackingDisabled = !0),
            (utils.userPreferences.allowErrorsInCallback = !0),
            this.closeBanner(),
            this.closeJourney();
        }
