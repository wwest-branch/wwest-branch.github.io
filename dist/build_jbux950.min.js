...
var jb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:I(!1,1),alternative_browser_fingerprint_id:I(!1,1),identity_id:I(!1,1),link_identifier:I(!1,1),sdk:I(!1,1),options:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),current_url:I(!1,1),screen_height:I(!1,2),screen_width:I(!1,2)}},kb={destination:"https://websdk-jbux950.branchbeta.link",endpoint:"/_r",method:"GET",L:!0,a:{sdk:I(!0,1),_t:I(!1,1),branch_key:I(!0,1)}},lb={destination:"",endpoint:"",method:"GET",
f:{link_url:I(!0,1)},a:{click:I(!0,1)}},mb={destination:"https://jbux950.link.beta.branch.io",endpoint:"/c",method:"POST",f:{link_url:I(!0,1)},a:{sdk:I(!1,1),phone:I(!0,1)}},nb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:J({amount:I(!0,2),bucket:I(!1,1),calculation_type:I(!0,2),creation_source:I(!0,2),expiration:I(!1,1),location:I(!0,2),prefix:I(!1,1),type:I(!0,1)})},ob={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",f:{code:I(!0,1)},a:J({})},pb={destination:"https://jbux950.api.beta.branch.io",
endpoint:"/v1/applycode",method:"POST",f:{code:I(!0,1)},a:J({})},qb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:J({session_id:I(!0,1)})},rb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:J({identity_id:I(!0,1),identity:I(!0,1)})},sb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/referrals",method:"GET",f:{identity_id:I(!0,1)},a:J({})},tb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",a:J({begin_after_id:I(!1,
1),bucket:I(!1,1),direction:I(!1,2),length:I(!1,2),link_click_id:I(!1,1)})},ub={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:J({branch_key:I(!0,1),identity:I(!0,1)})},vb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/redeem",method:"POST",a:J({amount:I(!0,2),bucket:I(!0,1),identity_id:I(!0,1)})},wb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/url",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),feature:I(!1,1),identity_id:I(!0,
1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1),instrumentation:I(!1,1)})},xb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/qr-code",method:"POST",qa:"obj",a:J({alias:I(!1,1),campaign:I(!1,1),channel:I(!1,1),data:I(!1,1),qr_code_settings:I(!1,1),feature:I(!1,1),identity_id:I(!0,1),stage:I(!1,1),tags:I(!1,3),type:I(!1,2),source:I(!1,1)})},yb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/deepview",L:!0,method:"POST",a:J({campaign:I(!1,1),_t:I(!1,1),channel:I(!1,1),data:I(!0,1),
feature:I(!1,1),link_click_id:I(!1,1),open_app:I(!1,4),append_deeplink_path:I(!1,4),stage:I(!1,1),tags:I(!1,3),deepview_type:I(!0,1),source:I(!0,1)})},zb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:I(!0,1),instrumentation:I(!1,1)}},Ab={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:I(!0,1),metadata:I(!0,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4)})},Bb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/event",
method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),commerce_data:I(!0,0)})},Cb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v2/event/standard",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,1)}},Db={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v2/event/custom",method:"POST",a:{name:I(!0,1),user_data:I(!0,1),custom_data:I(!1,1),event_data:I(!1,1),content_items:I(!1,1),customer_event_alias:I(!1,
1)}},Eb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),identity_id:I(!1,1)})},Fb={destination:"https://jbux950.api.beta.branch.io",
endpoint:"/v1/dismiss",method:"POST",a:J({event:I(!0,1),metadata:I(!1,0),initial_referrer:I(!1,1),tracking_disabled:I(!1,4),branch_view_id:I(!1,1),no_journeys:I(!1,4),user_language:I(!1,1),open_app:I(!1,4),has_app_websdk:I(!1,4),source:I(!1,1),feature:I(!1,1),is_iframe:I(!1,4),data:I(!1,0),callback_string:I(!1,1),journey_displayed:I(!1,4),audience_rule_id:I(!1,1),journey_dismissals:I(!1,0),dismissal_source:I(!1,1)})},Gb={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/cpid",method:"POST",a:{user_data:I(!0,
1)}},Ib={destination:"https://jbux950.api.beta.branch.io",endpoint:"/v1/cpid/latd",method:"POST",a:{user_data:I(!0,1)}};function Jb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.A={},c}}function K(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function Kb(a){return"true"===a?!0:"false"===a?!1:a}function Lb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function Mb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:Kb(a.substring(b+1,a.length))}}
...
b.substring(0,4)?"https://jbux950.link.beta.branch.io"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=Fa(a.referring_link));h.D=a.browser_fingerprint_id;return a}ra&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var h=this;h.o=1;-1<b.indexOf("key_")?h.i=b:h.W=b;c=c&&G(c,"object")?c:{};oa=(h.G=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:oa;pa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:pa;qa=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:qa;
...
Z.prototype.sendSMS=Y(1,function(a,b,c,d){function e(c){f.b(mb,{link_url:c,phone:b},function(b){a(b||null)})}var f=this;if("function"===typeof d)d={};else if("undefined"===typeof d||null===d)d={};d.make_new_link=d.make_new_link||!1;c.channel&&"app banner"!==c.channel||(c.channel="sms");var l=V(f);l&&!d.make_new_link?e(Fa(l)):f.b(wb,z(c),function(b,c){if(b)return a(b);var d=c.url;/(bnc.lt\/|(jbux950\.branchbeta|app)\.link\/)/.test(d)||(d="https://jbux950.link.beta.branch.io/"+Ta(d));f.b(lb,{link_url:d,click:"click"},function(b,c){if(b)return a(b);
